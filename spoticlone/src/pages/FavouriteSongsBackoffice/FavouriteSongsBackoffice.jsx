...
const FavouritesSongBackoffice = () => {
    ...
    <div className="row">
      ...
      <div className="backoffice-container">
        <Box sx={{ bgcolor: theme.palette.primary.main, height: "100vh" }}>
          ...
          <input type="search" class="input-search-home" placeholder="Usuario o canción" disabled={loading} onChange={(e) => setText(e.target.value)} ></input>
...
export default FavouritesSongBackoffice;
